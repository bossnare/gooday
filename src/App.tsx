...
import { History, StretchHorizontal } from 'lucide-react';
    ...
    <>
      ...
      <div className="flex">
        ...
        <aside
          ...
          } bg-white w-5/6 lg:translate-x-0 will-change-transform h-full flex flex-col transition-transform duration-400 ease-in-out z-10 border-r-1 border-r-gray-100 lg:sticky top-0 left-0 lg:h-auto fixed`}
        >
